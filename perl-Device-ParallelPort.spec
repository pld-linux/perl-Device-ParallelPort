...
%description -l pl
Modu³ sterownika portu równoleg³ego. Ten modu³ dostarcza API do
wszystkich portów równoleg³ych, daj±c mo¿liwo¶æ pisania dowolnej
liczby sterowników. Dostêpne s± modu³y dla Linuksa (zarówno dzia³aj±cy
